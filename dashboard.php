                        ...
                        const myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                        ...
                                        data: [0.9, 1.4, 2.1, 3.3, 4.9, 6.8, 9.4, 12.9,
                                            17.3, 23.1, 30
                                        ],
                                        backgroundColor: [
                                            'rgba(255, 99, 132, 0.2)',
                ...
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        const myChart3 = new Chart(ctx3, {
                            type: 'radar',
                            data: {
                                labels: ['Brisa Leve', 'Brisa fraca', 'Brisa moderada',
                                    'Brisa forte',
                                    'Vento fresco', 'Vento forte', 'ventania',
                                    'ventania forte',
                                    'Tempestade'
                        ...
                        <div class="table-wrapper">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr data-status="activo">
                                        <td>2</td>
                                        <td><a>Sensor de Temperatura</a></td>
                                    ...
                                    <tr data-status="inactivo">
                                        <td>4</td>
                                        <td><a>Sensor de precipitação</a></td>
                                        <td>06/09/2016</td>
